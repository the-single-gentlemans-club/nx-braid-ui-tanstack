import { Heading, Text, Stack } from 'braid-design-system';
        ...
        <div className="container">
          <div id="welcome">
            <Stack space="medium">
              ...
              <Text weight="regular">Hello there,</Text>
              <Heading level="1"> Welcome {title} 👋</Heading>
            </Stack>
          </div>
          ...
          <div id="middle-content">
            ...
            <div id="other-links">
              ...
              <div id="nx-cloud" className="rounded shadow">
                ...
                <a
                  href="https://cloud.nx.app/connect/KVVm0Prxgm"
                  target="_blank"
                  rel="noreferrer"
                >
